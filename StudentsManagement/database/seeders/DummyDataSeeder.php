...
class DummyDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $colleges = [
            ['name' => 'Mumbai Institute of Technology', 'code' => 'MIT001', 'city' => 'Mumbai', 'state' => 'Maharashtra', 'phone' => '9876543210', 'email' => 'contact@mit.edu', 'principal_name' => 'Dr. Rajesh Kumar', 'address' => '123 Tech Park, Mumbai', 'status' => 'active'],
            ['name' => 'Delhi College of Engineering', 'code' => 'DCE001', 'city' => 'Delhi', 'state' => 'Delhi', 'phone' => '9876543211', 'email' => 'contact@dce.edu', 'principal_name' => 'Prof. Priya Sharma', 'address' => '456 Engineering Square, Delhi', 'status' => 'active'],
            ['name' => 'Bangalore Tech Academy', 'code' => 'BTA001', 'city' => 'Bangalore', 'state' => 'Karnataka', 'phone' => '9876543212', 'email' => 'contact@bta.edu', 'principal_name' => 'Dr. Amit Patel', 'address' => '789 Innovation Hub, Bangalore', 'status' => 'active'],
        ];

        foreach ($colleges as $collegeData) {
            College::firstOrCreate(['code' => $collegeData['code']], $collegeData);
        }

        $this->command->info('Colleges created: ' . College::count());
        ...
        foreach ($batches as $batch) {
            ...
            for ($i = 0; $i < $numStudents; $i++) {
                ...
                $tuitionFee = $batch->total_fee * 0.70; // 70% of total
                $admissionFee = $batch->total_fee * 0.30; // 30% of total
                $examFee = rand(0, 1) ? rand(1000, 5000) : 0; // Optional
                $hostelFee = rand(0, 1) ? rand(5000, 15000) : 0; // Optional
                $busFee = rand(0, 1) ? rand(1000, 3000) : 0; // Optional
                
                $totalFee = $tuitionFee + $admissionFee + $examFee + $hostelFee + $busFee;
