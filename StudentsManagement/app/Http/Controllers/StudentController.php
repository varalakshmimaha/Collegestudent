...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'bus_fee' => 'nullable|numeric|min:0',
        ...
        // Fee fields are already validated and calculated on the frontend
        // total_fee comes from: tuition_fee + admission_fee + exam_fee + hostel_fee + bus_fee
        // final_fee comes from: total_fee - discount
    ...
    public function update(Request $request, string $id)
    {
        ...
        // The form already sends total_fee and final_fee calculated on the frontend
        // Just ensure they're included in validated data
        $validated['total_fee'] = (float)($request->total_fee ?? 0);
        $validated['final_fee'] = (float)($request->final_fee ?? 0);
