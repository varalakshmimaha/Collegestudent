...
class ReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Students Data for Students Report
        $studentsData = (clone $studentQuery)->with(['batch', 'branch'])->limit(50)->get();
        ...
        $totalStudentFees = (clone $studentQuery)->sum('final_fee');
        ...
        return view('reports.index', compact(
            ...
            'studentsData', 'activeStudents', 'graduatedStudents', 'totalStudentFees'
        ));
    }
    ...
    public function exportStudentsReport(Request $request)
    {
        ...
        $students = $studentsQuery->with(['batch', 'branch'])->get();

        $filename = 'students_report_' . now()->format('Y_m_d_H_i_s') . '.csv';
        $headers = [
