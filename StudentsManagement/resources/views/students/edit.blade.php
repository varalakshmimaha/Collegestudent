...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="mt-8">
        <form action="{{ route('students.update', $student->id) }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" autocomplete="off">
            ...
            <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm mb-6">
                <h3 class="text-lg font-bold text-gray-800 mb-6">Fee Details</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                    <!-- Tuition Fee -->
                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1" for="tuition_fee">
                            Tuition Fee <span class="text-red-500">*</span>
                        </label>
                        <input class="shadow-sm appearance-none border border-gray-200 rounded-xl w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" id="tuition_fee" type="number" step="0.01" name="tuition_fee" value="{{ old('tuition_fee', $student->tuition_fee ?? 0) }}" oninput="calculateTotalFee()">
                    </div>

                    <!-- Admission Fee -->
                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1" for="admission_fee">
                            Admission Fee <span class="text-red-500">*</span>
                        </label>
                        <input class="shadow-sm appearance-none border border-gray-200 rounded-xl w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" id="admission_fee" type="number" step="0.01" name="admission_fee" value="{{ old('admission_fee', $student->admission_fee ?? 0) }}" oninput="calculateTotalFee()">
                    </div>

                    <!-- Exam Fee (Optional) -->
                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1" for="exam_fee">
                            Exam Fee <span class="text-gray-400 text-[9px]">(Optional)</span>
                        </label>
                        <input class="shadow-sm appearance-none border border-gray-200 rounded-xl w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" id="exam_fee" type="number" step="0.01" name="exam_fee" value="{{ old('exam_fee', $student->exam_fee ?? 0) }}" oninput="calculateTotalFee()">
                    </div>

                    <!-- Hostel Fee (Optional) -->
                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1" for="hostel_fee">
                            Hostel Fee <span class="text-gray-400 text-[9px]">(Optional)</span>
                        </label>
                        <input class="shadow-sm appearance-none border border-gray-200 rounded-xl w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" id="hostel_fee" type="number" step="0.01" name="hostel_fee" value="{{ old('hostel_fee', $student->hostel_fee ?? 0) }}" oninput="calculateTotalFee()">
                    </div>

                    <!-- Bus Fee (Optional) -->
                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1" for="bus_fee">
                            Bus Fee <span class="text-gray-400 text-[9px]">(Optional)</span>
                        </label>
                        <input class="shadow-sm appearance-none border border-gray-200 rounded-xl w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" id="bus_fee" type="number" step="0.01" name="bus_fee" value="{{ old('bus_fee', $student->bus_fee ?? 0) }}" oninput="calculateTotalFee()">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                    <!-- Total Fee (Mandatory) -->
                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1" for="total_fee">
                            Total Fee <span class="text-red-500">*</span>
                        </label>
                        <input class="shadow-sm appearance-none border border-gray-200 rounded-xl w-full py-3 px-4 text-gray-800 bg-gray-100 leading-tight focus:outline-none font-bold" id="total_fee" type="number" step="0.01" name="total_fee" value="{{ old('total_fee', $student->total_fee) }}" readonly>
                    </div>
                    ...
                    <div>
                        ...
                        <input class="shadow-sm appearance-none border border-gray-200 rounded-xl w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" id="discount" type="number" step="0.01" name="discount" value="{{ old('discount', $student->discount) }}" oninput="calculateFinalFee()">
                    </div>
                ...
                <div class="mt-6">
                    ...
                    <select class="shadow-sm appearance-none border border-gray-200 rounded-xl w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" id="payment_type" name="payment_type">
