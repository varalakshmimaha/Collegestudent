            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-5">
                            @php
                                // Use final_fee (calculated from new fee structure) for payable amount
                                $payable    = $student->final_fee ?? 0;
                            ...
                            <div class="flex flex-col">
                                ...
                                @endif
                                <span class="text-xs text-gray-400 line-through mt-0.5">Total: ₹{{ number_format(($student->total_fee ?? 0), 2) }}</span>
                                @if($student->discount > 0)
                                    <span class="text-[10px] text-green-600 font-bold">Discount: -₹{{ number_format($student->discount ?? 0, 2) }}</span>
                                @endif
                            </div>
                        </td>
                        <td class="px-6 py-5">
